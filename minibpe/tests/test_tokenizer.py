...
from minibpe import BasicTokenizer, RegexTokenizer, GPT4Tokenizer
...
def unpack(text):
    # we do this because 'pytest -v .' prints the arguments to the console, and we don't
    # want to print the entire contents of the file, it creates a mess.
